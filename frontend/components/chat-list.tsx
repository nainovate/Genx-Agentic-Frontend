              ...
              return (
                <div key={message.id}>
                  ...
                  <div className='flex gap-1 justify-end items-center'>
                    {index === messages.length - 1 && !show && <span className='text-gray-600 text-xs hover:underline cursor-pointer py-1'> NIA can make mistakes. Please double-check response.</span>}
                  </div>
                </div>
              )
            })}
